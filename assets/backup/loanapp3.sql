...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `email`, `activation_selector`, `activation_code`, `forgotten_password_selector`, `forgotten_password_code`, `forgotten_password_time`, `remember_selector`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES (4, '::1', 'ron', '$2y$10$bpJSW4MSVHd9/LYO1gclQukL9CxK5lw2IbgUDqt9l5U.ElXUbvJja', 'jameronjame@gmail.com', 'd37bc23c03212763c36e', '$2y$10$QkYrwEO.g90IB98ul9/2ROxNPBGHVmEMUPaSeic0Pk.Ch1wpb32Fq', NULL, NULL, NULL, NULL, NULL, 1625730850, 1625738975, 0, 'Ronil', 'M Cajan', 'SH Food Group 1', '091233545');
...
INSERT INTO `users_groups` (`id`, `user_id`, `group_id`) VALUES (9, 4, 2);
INSERT INTO `users_groups` (`id`, `user_id`, `group_id`) VALUES (10, 4, 3);
